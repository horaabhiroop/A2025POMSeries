...
public class RegisterPage {
	...
	public boolean userRegistration(String firstName, String lastName, String email, String phone, String password,
		...
		eleUtil.doSendKeysWithWait(this.firstName, AppConstants.MEDIUM_TIME_OUT, firstName);
		...
		String actSuccessMesg = eleUtil.waitForElementVisible(this.sucessMessg, AppConstants.MEDIUM_TIME_OUT)
				.getText();
